...
void XMy_prj_accelerator_Set_x(XMy_prj_accelerator *InstancePtr, u64 Data) {
    ...
    XMy_prj_accelerator_WriteReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_X_DATA, (u32)(Data));
    XMy_prj_accelerator_WriteReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_X_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMy_prj_accelerator_Get_x(XMy_prj_accelerator *InstancePtr) {
    ...
    Data += (u64)XMy_prj_accelerator_ReadReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_X_DATA + 4) << 32;
    return Data;
}
...
void XMy_prj_accelerator_Set_score(XMy_prj_accelerator *InstancePtr, u64 Data) {
    ...
    XMy_prj_accelerator_WriteReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_SCORE_DATA, (u32)(Data));
    XMy_prj_accelerator_WriteReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_SCORE_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMy_prj_accelerator_Get_score(XMy_prj_accelerator *InstancePtr) {
    ...
    Data += (u64)XMy_prj_accelerator_ReadReg(InstancePtr->Control_BaseAddress, XMY_PRJ_ACCELERATOR_CONTROL_ADDR_SCORE_DATA + 4) << 32;
    return Data;
}
