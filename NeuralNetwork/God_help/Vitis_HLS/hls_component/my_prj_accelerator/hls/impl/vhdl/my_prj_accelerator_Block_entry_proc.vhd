...
entity my_prj_accelerator_Block_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_accelerator_Block_entry_proc is 
...
attribute shreg_extract : string;
    ...
    signal sub_out_0_fu_38_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= sub_out_0_fu_38_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, sub_out_0_fu_38_p2, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= sub_out_0_fu_38_p2;
        else 
            ap_return <= ap_return_preg;
        end if; 
    end process;

    sub_out_0_fu_38_p2 <= std_logic_vector(unsigned(N) + unsigned(ap_const_lv32_FFFFFFFF));
end behav;
