...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.my_prj_accelerator.autotvin_N.dat"
         "c.my_prj_accelerator.autotvin_x_V_data_V.dat"
         "c.my_prj_accelerator.autotvin_x_V_keep_V.dat"
         "c.my_prj_accelerator.autotvin_x_V_strb_V.dat"
         "c.my_prj_accelerator.autotvin_x_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.my_prj_accelerator.autotvout_score_V_data_V.dat"
         "rtl.my_prj_accelerator.autotvout_score_V_keep_V.dat"
         "rtl.my_prj_accelerator.autotvout_score_V_strb_V.dat"
         "rtl.my_prj_accelerator.autotvout_score_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
