...
module my_prj_accelerator_hls_deadlock_idx0_monitor ( // for module my_prj_accelerator_my_prj_accelerator_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 my_prj_accelerator_hls_deadlock_idx1_monitor my_prj_accelerator_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
