...
HLS_SOURCES = ../../../../../../Python/my-hls-test/myproject_test.cpp ../../../../../../Python/my-hls-test/firmware/myproject.cpp
...
$(ObjDir)/myproject_test.o: ../../../../../../Python/my-hls-test/myproject_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../Python/my-hls-test/myproject_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/myproject_test.d

$(ObjDir)/myproject.o: ../../../../../../Python/my-hls-test/firmware/myproject.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../Python/my-hls-test/firmware/myproject.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
