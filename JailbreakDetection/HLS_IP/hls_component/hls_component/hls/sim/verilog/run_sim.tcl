...
if {[file isfile my_prj_accelerator.autotvin.dat]} {
	file delete -force my_prj_accelerator.autotvin.dat
}

if {[file isfile my_prj_accelerator.autotvout.dat]} {
	file delete -force my_prj_accelerator.autotvout.dat
}
