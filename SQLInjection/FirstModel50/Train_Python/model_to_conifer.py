...
# # # os.environ['JSON_ROOT'] = '/home/denisaa/Desktop/Licenta/json_include'

# # xilinx_path = '../../../../../tools/Xilinx/Vitis_HLS/2024.2/include'
# # # firmware_path = os.path.abspath('forest_cpp/firmware')

# # project_dir = os.path.abspath('forest_cpp')
# # firmware_dir = os.path.join(project_dir, 'firmware')

# # os.environ['CPATH'] = f"{xilinx_path}:{project_dir}"
