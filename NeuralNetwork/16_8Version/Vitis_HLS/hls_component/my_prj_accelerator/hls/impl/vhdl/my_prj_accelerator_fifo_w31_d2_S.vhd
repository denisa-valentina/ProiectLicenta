...
entity my_prj_accelerator_fifo_w31_d2_S is 
    generic (
...
architecture rtl of my_prj_accelerator_fifo_w31_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component my_prj_accelerator_fifo_w31_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 31;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_my_prj_accelerator_fifo_w31_d2_S_ShiftReg : my_prj_accelerator_fifo_w31_d2_S_ShiftReg
    generic map (
...
entity my_prj_accelerator_fifo_w31_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 31;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end my_prj_accelerator_fifo_w31_d2_S_ShiftReg;

architecture rtl of my_prj_accelerator_fifo_w31_d2_S_ShiftReg is
