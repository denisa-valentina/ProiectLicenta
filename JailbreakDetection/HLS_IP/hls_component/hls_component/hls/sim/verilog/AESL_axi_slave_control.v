...
//------------------------Parameter----------------------
`define TV_IN_N "../tv/cdatafile/c.my_prj_accelerator.autotvin_N.dat"
...
parameter my_prj_accelerator_continue_addr = 0;
parameter my_prj_accelerator_auto_start_addr = 0;
parameter N_data_in_addr = 16;
...
assign TRAN_control_write_data_finish = 1 & N_write_data_finish;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (write_start_count >= 514) begin
            write_start_run_flag <= 0; 
        end
