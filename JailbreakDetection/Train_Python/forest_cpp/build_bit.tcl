...
startgroup
create_bd_cell -type ip -vlnv cern.ch:conifer:${top}:${version} conifer_my_prj
endgroup

startgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system_0/M_AXI_HPM0_FPD} Slave {/conifer_my_prj/s_axi_control} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins conifer_my_prj/s_axi_control]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/conifer_my_prj/m_axi_gmem0} Slave {/processing_system_0/S_AXI_HP0_FPD} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins processing_system_0/S_AXI_HP0_FPD]
endgroup
