...
/dts-v1/;
#line 1 "../platform/hw/sdt/zynqmp.dtsi"
 ...
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/dma/xlnx-zynqmp-dpdma.h"
/* SPDX-License-Identifier: (GPL-2.0 OR MIT) */
/*
 * Copyright 2019 Laurent Pinchart <laurent.pinchart@ideasonboard.com>
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/gpio/gpio.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
...
#line 1 "../platform/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
/* SPDX-License-Identifier: GPL-2.0 OR MIT */
/*
 * This header provides constants for the ARM GIC.
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/interrupt-controller/irq.h"
/*
 ...
 * defined in this header.
 */
#line 11 "../platform/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
 ...
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/power/xlnx-zynqmp-power.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/reset/xlnx-zynqmp-resets.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 22 "../platform/hw/sdt/zynqmp.dtsi"
/ {
...
#line 1 "../platform/hw/sdt/zynqmp-clk-ccf.dtsi"
// SPDX-License-Identifier: GPL-2.0+
/*
 ...
 * Michal Simek <michal.simek@amd.com>
 */
#line 1 "../platform/hw/sdt/include/dt-bindings/clock/xlnx-zynqmp-clk.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 ...
 *
 */
#line 12 "../platform/hw/sdt/zynqmp-clk-ccf.dtsi"
/ {
...
&zynqmp_dpdma {
	...
	assigned-clocks = <&zynqmp_clk 20>; /* apll */
};
...
/ {
	amba_pl: amba_pl {
		...
		axi_dma_0: dma@a0010000 {
			...
			dma_channel_a0010030: dma-channel@a0010030 {
				xlnx,datawidth = <0x20>;
				xlnx,device-id = <0x0>;
		...
		my_prj_accelerator_0: my_prj_accelerator@a0020000 {
			compatible = "xlnx,my-prj-accelerator-1.0";
			xlnx,ii = "undef";
			xlnx,machine = <64>;
			xlnx,s-axi-control-addr-width = <5>;
			xlnx,rable = <0>;
			xlnx,ip-name = "my_prj_accelerator";
			...
			xlnx,latency = "undef";
			xlnx,name = "my_prj_accelerator_0";
		};
	};
};
#line 1 "../platform/hw/sdt/pcw.dtsi"
	&psu_cortexa53_0 {
		...
		cpu-frequency = <1200000000>;
		xlnx,cpu-clk-freq-hz = <1200000000>;
		xlnx,pss-gt-ref-clk-freq = <33333000>;
		xlnx,pss-ref-clk-freq = <33333333>;
		bus-handle = <&amba>;
		xlnx,pss-aux-ref-clk-freq = <33333000>;
		xlnx,psu-device = "PS8a";
		xlnx,timestamp-clk-freq = <100000000>;
		stamp-frequency = <100000000>;
	...
	&amba {
		...
		psu_ddr_0: psu_ddr@0 {
			...
			xlnx,ddrc-act-freq-hz = <1050000000>;
	...
	&psu_pmu_0 {
		...
		xlnx,pss-ref-clk-freq = "33.333333";
		i-cache-size = <8192>;
	...
	&mc {
		...
		xlnx,ddrc-clk-freq-hz = <525000000>;
		xlnx,qos-enable = <0>;
	...
	&sdhci1 {
		...
		xlnx,sdio-clk-freq-hz = <187500000>;
	...
	&gem3 {
		...
		xlnx,enet-tsu-clk-freq-hz = <250000000>;
	...
	&can1 {
		xlnx,rable = <0>;
		status = "okay";
		xlnx,can-clk-freq-hz = <100000000>;
	...
	&i2c1 {
		...
		status = "okay";
		xlnx,clock-freq = <100000000>;
		xlnx,i2c-clk-freq-hz = <100000000>;
	...
	&psu_cortexr5_0 {
		...
		xlnx,cpu-clk-freq-hz = <500000000>;
		xlnx,psu-silicon-version = <3>;
		xlnx,pss-ref-clk-freq = <33333333>;
		access-val = <0xff>;
		bus-handle = <&amba>;
...
#line 6 "../platform/hw/sdt/system-top.dts"
/ {
	board = "zcu104";
	...
	cpus_a53: cpus-a53@0 {
		...
		address-map = <0x0 0xf0000000 &amba 0x0 0xf0000000 0x0 0x10000000>,
			      ...
			      <0x0 0xa0000000 &axi_uartlite_0 0x0 0xa0000000 0x0 0x10000>,
			      <0x0 0xa0010000 &axi_dma_0 0x0 0xa0010000 0x0 0x10000>,
			      <0x0 0xa0020000 &my_prj_accelerator_0 0x0 0xa0020000 0x0 0x10000>,
	...
	cpus_r5_0: cpus-r5@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      ...
			      <0xa0000000 &axi_uartlite_0 0xa0000000 0x10000>,
			      <0xa0010000 &axi_dma_0 0xa0010000 0x10000>,
			      <0xa0020000 &my_prj_accelerator_0 0xa0020000 0x10000>,
